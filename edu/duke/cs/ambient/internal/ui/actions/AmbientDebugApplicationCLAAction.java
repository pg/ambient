 ...
 */
public class AmbientDebugApplicationCLAAction extends AmbientRunAction {
    public AmbientDebugApplicationCLAAction() {
        super();
    }
    ...
    public void run(IAction action) {
        ...
        if (getSelection() instanceof IStructuredSelection) {
            launch(getSelection(), ILaunchManager.DEBUG_MODE);
        } else
